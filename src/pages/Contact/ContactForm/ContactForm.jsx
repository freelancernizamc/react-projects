...
const ContactForm = () => {
  return (
    <div className="bg-[#021D49] text-white md:p-20 p-10">
      <div className="md:flex md:justify-center gap-12 p-5 ">
        <div className="w-full md:w-2/3 lg:w-1/3 md:mr-5 md:mt-5 py-2 lg:mr-0 pt-5 bg-[#082C6B] rounded-lg z-50 sm:py-4">
        ...
        <div className="w-full md:w-2/3 lg:w-1/3 bg-[#082C6B] rounded-lg sm:mt-3 sm:pt-1 px-2 lg:pr-4 z-50">
          ...
          <div className="md:ml-6">
            <form>
              ...
              <div className="md:text-center">
                <button className="w-[160px] bg-yellow-500 hover:bg-blue-950 hover:text-white md:mr-0 rounded-lg md:ml-28 mb-5 md:px-1 py-2">
                  Submit your request
                </button>
              </div>
            </form>
